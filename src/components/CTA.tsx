...
export default function CTA() {
  return (
    <section className="py-24 px-6 text-center bg-surface-container-lowest">
       <h3 className="font-serif text-4xl text-on-surface mb-4">Ready to start your future?</h3>
